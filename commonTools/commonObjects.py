...
combineVariableDict = {
    ...
    "2023":{
        ...
        "Njets2p5": CreateVariableParameters(gen_variable="NJ", reco_variable="Njets2p5", bins=["0p0_1p0", "1p0_2p0", "2p0_3p0", "3p0_100p0"], year="2023", BMW=BMW),
        "ptJ0": CreateVariableParameters(gen_variable="PTJ0", reco_variable="first_jet_pt", bins=["0p0_30p0", "30p0_75p0", "75p0_120p0", "120p0_200p0", "200p0_10000p0"], year="2023", BMW=BMW)
    }
}