...
class FinalFits(law.Task):
    ...
    asimov_fit_per_category = law.Parameter(default=False, description="Run Asimov fits per category while masking the others")
    ...
    def requires(self):
        ...
        if convert_boolean_string(self.asimov_fit_per_category):
