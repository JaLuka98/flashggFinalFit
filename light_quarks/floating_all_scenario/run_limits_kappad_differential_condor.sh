...
# kappa_d to Condor. kappa_s and kappa_u are profiled at every scan point.
#
# Build the workspace first with:
#   bash light_quarks/floating_all_scenario/t2w_three_flavor_differential.sh
#
# Usage:
#   bash light_quarks/floating_all_scenario/run_limits_kappad_differential_condor.sh
...
OUTPUT_DIR=${PTH_OUTPUT}/LightQuarks_floating_all_kappad_differential_condor

SCAN_POINTS=21
SPLIT_POINTS=1
MASS=125.38
JOB_FLAVOUR=workday
TASK_NAME=LightQuarks_2024_PTH_three_flavor_diff_kappad_scan
COMBINE_NAME=LightQuarks_2024_PTH_three_flavor_diff_kappad_expected
MERGED_OUTPUT=merged_LightQuarks_2024_PTH_three_flavor_diff_kappad_expected.root
...
echo "============================================================"
echo " Three-flavor differential scan: kappa_d"
echo " (profiling kappa_s, kappa_u)"
echo "============================================================"
echo " Workspace:   ${WORKSPACE}"
echo " Output dir:  ${OUTPUT_DIR}"
echo " Scan points: ${SCAN_POINTS}  (one per Condor job)"
echo " POI scanned: kappa_d  in [-3, 3]"
echo " Profiled:    kappa_s, kappa_u"
...
combineTool.py -M MultiDimFit \
    ...
    -m ${MASS} \
    --saveNLL \
    --trackParameters kappa_s,kappa_u \
