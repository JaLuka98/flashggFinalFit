...
# kappa_s to Condor. kappa_u and kappa_d are profiled at every scan point.
#
# Build the workspace first with:
#   bash light_quarks/floating_all_scenario/t2w_three_flavor_differential.sh
#
# Usage:
#   bash light_quarks/floating_all_scenario/run_limits_kappas_differential_condor.sh
...
OUTPUT_DIR=${PTH_OUTPUT}/LightQuarks_floating_all_kappas_differential_condor

SCAN_POINTS=21
SPLIT_POINTS=1
MASS=125.38
JOB_FLAVOUR=workday
TASK_NAME=LightQuarks_2024_PTH_three_flavor_diff_kappas_scan
COMBINE_NAME=LightQuarks_2024_PTH_three_flavor_diff_kappas_expected
MERGED_OUTPUT=merged_LightQuarks_2024_PTH_three_flavor_diff_kappas_expected.root
...
echo "============================================================"
echo " Three-flavor differential scan: kappa_s"
echo " (profiling kappa_u, kappa_d)"
echo "============================================================"
echo " Workspace:   ${WORKSPACE}"
echo " Output dir:  ${OUTPUT_DIR}"
echo " Scan points: ${SCAN_POINTS}  (one per Condor job)"
echo " POI scanned: kappa_s  in [-3, 3]"
echo " Profiled:    kappa_u, kappa_d"
...
combineTool.py -M MultiDimFit \
    ...
    -m ${MASS} \
    --saveNLL \
    --trackParameters kappa_u,kappa_d \
