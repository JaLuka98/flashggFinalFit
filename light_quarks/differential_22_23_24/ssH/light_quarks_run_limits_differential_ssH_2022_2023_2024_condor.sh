...
# Submit the 2022+2023+2024 PTH ssH differential expected scan.
...
WORKSPACE=${PTH_OUTPUT}/Combine/LightQuarks_kappaq_ssH_Datacard_PTH_2022_2023_2024.root
OUTPUT_DIR=${PTH_OUTPUT}/LightQuarks_limits_kappaq_ssH_PTH_2022_2023_2024_condor

SCAN_RANGE="kappa_q=-2,2"
SCAN_POINTS=21
SPLIT_POINTS=1
MASS=125.38
MEMORY=12000
...
TASK_NAME=LightQuarks_2022_2023_2024_PTH_ssH_kappaq_scan
COMBINE_NAME=LightQuarks_2022_2023_2024_PTH_ssH_kappaq_expected
...
if [ ! -f "${WORKSPACE}" ]; then
    ...
    echo "  bash light_quarks/differential_22_23_24/ssH/light_quarks_t2w_differential_ssH_2022_2023_2024.sh"
    exit 1
fi
...
echo "Submitting 2022+2023+2024 PTH ssH scan"
