...
# Build the 2022+2023+2024 PTH ssH differential shape-only workspace.
...
SHAPE_ONLY_DATACARD=${PTH_OUTPUT}/Combine/Datacard_PTH_2022_2023_2024_ssH_shape_only.txt
OUTPUT=${PTH_OUTPUT}/Combine/LightQuarks_kappaq_ssH_shape_only_Datacard_PTH_2022_2023_2024.root
...
echo "Building 2022+2023+2024 PTH ssH shape-only workspace"
...
text2workspace.py ${SHAPE_ONLY_DATACARD} \
    ...
    -P light_quarks:light_quarks_differential_ssH_shape_only
