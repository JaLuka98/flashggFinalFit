...
# Build the 2022+2023+2024 PTH ssH differential workspace.
...
OUTPUT=${PTH_OUTPUT}/Combine/LightQuarks_kappaq_ssH_Datacard_PTH_2022_2023_2024.root
...
echo "Building 2022+2023+2024 PTH ssH differential workspace"
...
text2workspace.py ${DATACARD} \
    ...
    -P light_quarks:light_quarks_differential_ssH
