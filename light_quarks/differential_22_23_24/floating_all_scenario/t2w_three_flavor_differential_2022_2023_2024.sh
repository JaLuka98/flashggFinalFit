...
# Build the 2022+2023+2024 PTH three-flavor differential workspace.
...
OUTPUT=${PTH_OUTPUT}/Combine/LightQuarks_three_flavor_Datacard_PTH_2022_2023_2024.root
...
echo "Building 2022+2023+2024 PTH three-flavor differential workspace"
