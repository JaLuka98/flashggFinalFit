...
# Merge and plot one 2022+2023+2024 PTH three-flavor shape-only scan.
# Usage: bash light_quarks/differential_22_23_24/floating_all_scenario/hadd_plot_three_flavor_shape_only.sh kappa_s [points]
