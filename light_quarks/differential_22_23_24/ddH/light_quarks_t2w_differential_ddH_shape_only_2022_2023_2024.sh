...
# Build the 2022+2023+2024 PTH ddH differential shape-only workspace.
...
SHAPE_ONLY_DATACARD=${PTH_OUTPUT}/Combine/Datacard_PTH_2022_2023_2024_ddH_shape_only.txt
OUTPUT=${PTH_OUTPUT}/Combine/LightQuarks_kappad_ddH_shape_only_Datacard_PTH_2022_2023_2024.root
...
echo "Building 2022+2023+2024 PTH ddH shape-only workspace"
