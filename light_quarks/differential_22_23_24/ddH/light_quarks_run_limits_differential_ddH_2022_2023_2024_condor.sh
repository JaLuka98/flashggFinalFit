...
# Submit the 2022+2023+2024 PTH ddH differential expected scan.
...
WORKSPACE=${PTH_OUTPUT}/Combine/LightQuarks_kappad_ddH_Datacard_PTH_2022_2023_2024.root
OUTPUT_DIR=${PTH_OUTPUT}/LightQuarks_limits_kappad_ddH_PTH_2022_2023_2024_condor

SCAN_RANGE="kappa_d=-2,2"
SCAN_POINTS=21
SPLIT_POINTS=1
MASS=125.38
MEMORY=12000
...
TASK_NAME=LightQuarks_2022_2023_2024_PTH_ddH_kappad_scan
COMBINE_NAME=LightQuarks_2022_2023_2024_PTH_ddH_kappad_expected
...
if [ ! -f "${WORKSPACE}" ]; then
    ...
    echo "  bash light_quarks/differential_22_23_24/ddH/light_quarks_t2w_differential_ddH_2022_2023_2024.sh"
    exit 1
fi
...
echo "Submitting 2022+2023+2024 PTH ddH scan"
...
echo "  bash ${FLASHGG_DIR}/light_quarks/differential_22_23_24/ddH/light_quarks_hadd_plot_differential_ddH_2022_2023_2024.sh"
