...
python /eos/home-n/niharrin/PhD/Higgs/CMSSW_10_2_13/src/flashggFinalFit/Datacard/makeYields.py --cat worst_resolution --procs auto --ext earlyAnalysis_gg2h --mass 125 --inputWSDirMap 2022preEE=../input_output_2022preEE_gg2h/ws_signal,2022postEE=../input_output_2022postEE_gg2h/ws_signal --sigModelWSDir ./Models/signal --sigModelExt packaged --bkgModelWSDir ./Models/background --bkgModelExt multipdf  --mergeYears --skipZeroes --doSystematics
