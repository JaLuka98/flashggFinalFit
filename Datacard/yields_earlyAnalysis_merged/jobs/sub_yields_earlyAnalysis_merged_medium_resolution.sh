...
python /eos/home-n/niharrin/PhD/Higgs/CMSSW_10_2_13/src/flashggFinalFit/Datacard/makeYields.py --cat medium_resolution --procs auto --ext earlyAnalysis_merged --mass 125 --inputWSDirMap 2022preEE=../input_output_2022preEE/ws_signal,2022postEE=../input_output_2022postEE/ws_signal --sigModelWSDir ./Models/signal --sigModelExt packaged --bkgModelWSDir ./Models/background --bkgModelExt multipdf  --mergeYears --skipZeroes --doSystematics
