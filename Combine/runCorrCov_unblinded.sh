...
python3 makeCorrMatrix.py --inputJson ./inputs_robustHesse.json --mode differential_${differential_variable} --input ../Combine/runFits_${differential_variable}/hesse/robustHessefirstStep_data.root --output ../Combine/runFits_${differential_variable}/hesse/Plots/data --translate ./poi_differential_hesse.json  --doObserved
python3 makeCorrMatrix.py --inputJson ./inputs_robustHesse.json --mode differential_${differential_variable} --input ../Combine/runFits_${differential_variable}/hesse/robustHessefirstStep_data.root --output ../Combine/runFits_${differential_variable}/hesse/Plots/data --translate ./poi_differential_hesse.json  --doObserved --doCov
