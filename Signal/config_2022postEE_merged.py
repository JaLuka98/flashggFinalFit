...
signalScriptCfg = {
  ...
  'ext':'earlyAnalysis_2022postEE_merged', # output directory extension
  'analysis':'earlyAnalysisInOutMerged', # To specify replacement dataset and XS*BR mapping (defined in ./tools/replacementMap.py and ./tools/XSBRMap.py respectively)
