...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'../input_output_rapidity_2022postEE/ws_signal/', # dir storing flashgg workspaces
  ...
  'ext':'earlyAnalysis_rapidity_2022postEE', # output directory extension
  'analysis':'earlyAnalysisDiffYH', # To specify replacement dataset and XS*BR mapping (defined in ./tools/replacementMap.py and ./tools/XSBRMap.py respectively)
