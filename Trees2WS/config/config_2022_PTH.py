...
trees2wsCfg = {
  ...
  'mainVars':["CMS_hgg_mass","weight","weight_central","dZ","*Up","*Down","fiducialGeometricFlag", "diffVariable_GenPTH"],
  ...
  'systematicsVars':["CMS_hgg_mass","weight","fiducialGeometricFlag", "diffVariable_GenPTH"], # Variables to add to sytematic RooDataHists
